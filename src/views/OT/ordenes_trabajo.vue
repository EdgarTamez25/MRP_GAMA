    ...
    computed: {
      ...
      tamanioPantalla () {
        switch (this.$vuetify.breakpoint.name) {
          ...
          case 'sm': return this.$vuetify.breakpoint.height -300;break;
          case 'md': return this.$vuetify.breakpoint.height -300;break;
          case 'lg': return this.$vuetify.breakpoint.height -300;break;
          case 'xl': return this.$vuetify.breakpoint.height -300;break;
        }
      },
    },
